...
const breadcrumbs = [
  ...
  <Typography
    ...
    key="2"
  >
    <AssessmentTwoToneIcon sx={{ mr: 0.5 }} fontSize="inherit" />
    Data Analysis
  </Typography>,
];

class DataAnalyticsDashboard extends Component {
  state = {
    open: true,
  ...
  componentDidMount() {
    if (this.state.token && this.state.access !== "1") {
...
export default withCookies(DataAnalyticsDashboard);
